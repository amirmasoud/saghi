        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('slug')
                    ->required()
                    ->maxLength(255),
                Forms\Components\Textarea::make('strip_content')
                    ->maxLength(65535),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('strip_content'),
                Tables\Columns\TextColumn::make('plain_content'),
                Tables\Columns\TextColumn::make('html_content'),
